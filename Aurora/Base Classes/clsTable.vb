...
#Region "Private Functions"
    ...
    Private Sub AddFields(ByVal strTab As String, _
        ...
        Try
            ...
            If Not (strTab = "OWHS" Or strTab = "OITM" Or strTab = "INV1" Or strTab = "OWTR" Or strTab = "OUSR" Or strTab = "OITW" Or strTab = "RDR1" Or strTab = "OINV" Or strTab = "INV1") Then
                strTab = "@" + strTab
            End If
...
#Region "Public Functions"
    ...
    Public Sub CreateTables()
        Try
            ...
            AddFields("OINV", "InvType", "Invoice Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 30)
            ' AddFields("INV1", "ACRegi", "Air Craft Registration", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            '   AddFields("INV1", "ACType", "Air Craft Type", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            '  AddFields("OINV", "FltNo", "Flight No", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("INV1", "AirTA", "Airport Time Arrival", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            AddFields("INV1", "AirTD", "AirportTimeDeparture", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            '   AddFields("INV1", "Country", "Country", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            '  AddFields("INV1", "AirICAO", "AirportICAO", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
            ' AddFields("INV1", "AirIATA", "AirportIATA", SAPbobsCOM.BoFieldTypes.db_Alpha, , 50)
